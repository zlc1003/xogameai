...
if __name__ == '__main__':
    ...
    np.save(os.path.join(home_directory, 'xogameai',
            'agent_X_q_table_v4_1000000.npy'), agent_X.q_table)
    np.save(os.path.join(home_directory, 'xogameai',
            'agent_O_q_table_v4_1000000.npy'), agent_O.q_table)
